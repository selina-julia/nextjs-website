  ...
  return (
    <div>
      <Head>
        ...
        />
        <meta name="Selina Julia" content="Selina Julia" />
          ...
          <>
            <div className={utilStyles.headerbottom}>
              <p className={utilStyles.headingMd}>
                Hi, ich bin <span className={utilStyles.violet}>Selina</span>
              </p>
              ...
              <p className={`${utilStyles.headingMd} ${utilStyles.about}`}>
              ...
              <div className="row">
                <div className="col-md-9">
                  <div>
                    <h1>
                      Hi, ich bin{" "}
                      <span className={utilStyles.violet}>Selina.</span>
                    </h1>

                    <p className={utilStyles.about_text}>
                      Ich bin 22 Jahre alt und komme aus Seewalchen am Attersee,
                      in Oberösterreich. Zurzeit studiere ich Kommunikation,
                      Wissen, Medien im 6. Semester an der FH Hagenberg. Ich
                      hatte schon immer Spaß an kreativen und gestalterischen
                      Arbeiten und durch mein Studium habe ich meine
                      Leidenschaft für UI/UX Design und Web Entwicklung
                      entdeckt. Während meiner Zeit an der FH sowie im privaten
                      Bereich durfte ich bereits einige Projekte in diesem
                      Bereich umsetzen.
                    </p>
        ...
        <>
          <section className={utilStyles.message_section}>
            <div className={utilStyles.heading_wrapper}>
              ...
              <h2 className={utilStyles.style_h2}>
                Schreib mir eine Nachricht
              </h2>
              <p>
                Falls du noch Fragen hast oder gemeinsam ein Projekt starten
                möchtest, kannst du mir jederzeit gerne eine Nachricht
                schreiben!
              </p>
      ...
      <footer className={utilStyles.footer}>
        ...
        <div className={utilStyles.footer_navlinks}>
          <Link
            href={
              "https://www.linkedin.com/in/selina-julia-schindlauer-13aa091a1/"
            }
          >
            <a>Linkedin</a>
          </Link>
